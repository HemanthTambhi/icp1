...
import { idlFactory } from './masterverses-backend-backend.did.js';
export { idlFactory } from './masterverses-backend-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MASTERVERSES_BACKEND_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./masterverses-backend-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the masterverses-backend-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./masterverses-backend-backend.did.js")._SERVICE>}
 */
export const masterverses_backend_backend = createActor(canisterId);
